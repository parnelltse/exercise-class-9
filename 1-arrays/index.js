 ...
 */
var tavelPlaces =[];
tavelPlaces[0] = "Toronto";
tavelPlaces[1] = "New York";
tavelPlaces[2] = "Australia";
tavelPlaces[3] = "Spain";
console.log(tavelPlaces);// [ 'Toronto' , New York', 'Australia', 'Spain' ]
...
var courseNumber = schedule[2][0];
var courseName = schedule [2][1];
var credits = schedule[2][2];
console.log(`I am taking ${courseNumber}, ${courseName} that is worth ${credits} credits `);
